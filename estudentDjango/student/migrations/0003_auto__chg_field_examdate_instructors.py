...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExamDate.instructors'
        db.alter_column('student_examdate', 'instructors_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codelist.GroupInstructors'], null=True))

    def backwards(self, orm):

        # Changing field 'ExamDate.instructors'
        db.alter_column('student_examdate', 'instructors_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codelist.GroupInstructors']))
