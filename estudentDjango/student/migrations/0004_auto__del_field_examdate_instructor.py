...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExamDate.instructor'
        db.delete_column('student_examdate', 'instructor_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ExamDate.instructor'
        raise RuntimeError("Cannot reverse this migration. 'ExamDate.instructor' and its values cannot be restored.")
