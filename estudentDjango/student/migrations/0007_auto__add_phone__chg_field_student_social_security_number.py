...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Phone'
        db.create_table('student_phone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='student_phone', to=orm['student.Student'])),
        ))
        db.send_create_signal('student', ['Phone'])


        # Changing field 'Student.social_security_number'
        db.alter_column('student_student', 'social_security_number', self.gf('django.db.models.fields.CharField')(default=0, max_length=13))

    def backwards(self, orm):
        # Deleting model 'Phone'
        db.delete_table('student_phone')


        # Changing field 'Student.social_security_number'
        db.alter_column('student_student', 'social_security_number', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))
    ...
    models = {
        ...
        'student.examdate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructors': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['codelist.GroupInstructors']", 'null': 'True', 'blank': 'True'}),
        ...
        'student.phone': {
            ...
            'student': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'student_phone'", 'to': "orm['student.Student']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        'student.student': {
            ...
            'enrollment_number': ('django.db.models.fields.IntegerField', [], {'default': '63110004', 'unique': 'True', 'primary_key': 'True'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'social_security_number': ('django.db.models.fields.CharField', [], {'max_length': '13'}),
            'surname': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
