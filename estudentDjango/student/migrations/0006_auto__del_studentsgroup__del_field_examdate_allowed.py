...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExamDate.allowed'
        db.delete_column('student_examdate', 'allowed_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ExamDate.allowed'
        raise RuntimeError("Cannot reverse this migration. 'ExamDate.allowed' and its values cannot be restored.")
